...
public class TTT_LabelView extends JFrame implements View {
	...
	private class OnAction extends MouseAdapter {
		...
		@Override
		public void mouseExited(MouseEvent e) { board[row][col].setBackground(Color.GRAY); }
	...
	@Override
	public void showBoard(TTT_Model model) {
	...
	@Override
	public void showNextPlayer(TTT_Constants player) {
	...
	@Override
	public void showWinner(TTT_Constants player) {
